...
<article <?php post_class( 'post-module post-module-grid' ); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
	...
	<?php elseif ( 'gallery' === get_post_format() ) : ?>
		...
		<div class="post-thumbnail">
			...
			if ( $canos_post_gallery_imgs ) {
				$canos_post_gallery_size = 'canos_620x413';
	...
	<?php elseif ( ! get_theme_mod( 'canos_opt_archive_post_thumbnail' ) ) :
		...
		if ( has_post_thumbnail() ) :
			...
			$canos_post_thumb_size = 'canos_620x413'; ?>
