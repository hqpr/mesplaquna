...
<article <?php post_class( 'post-module post-module-full' ); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
	...
	<?php elseif ( 'gallery' === get_post_format() ) : ?>
		...
		<div class="post-thumbnail">
			...
			if ( $canos_post_gallery_imgs ) {
				$canos_post_gallery_size = ( get_theme_mod( 'canos_opt_archive_layout' ) == 'no-sidebar full-modules' ) ? 'canos_1300x554' : 'canos_833x554';
	...
	<?php elseif ( ! get_theme_mod( 'canos_opt_archive_post_thumbnail' ) ) :

		if ( has_post_thumbnail() ) :

			$canos_post_thumb_size = ( get_theme_mod( 'canos_opt_archive_layout' ) == 'no-sidebar full-modules' ) ? 'canos_1300x554' : 'canos_833x554';
			?>
	...
	<?php
	$canos_date_vis_var = ( get_theme_mod( 'canos_opt_archive_post_date' ) ) ? true : false;
	$canos_author_vis_var = ( get_theme_mod( 'canos_opt_archive_post_author' ) ) ? true : false;
	...
	<?php if ( ( get_theme_mod( 'canos_opt_archive_post_excerpt' ) == 'excerpt' ) || ( get_theme_mod( 'canos_opt_archive_post_excerpt' ) == 'excerpt+more' ) ) : ?>

	<div class="entry-summary" itemprop="text">
		<?php the_excerpt(); ?>
		<?php if ( get_theme_mod( 'canos_opt_archive_post_excerpt' ) == 'excerpt+more' ) : ?>
