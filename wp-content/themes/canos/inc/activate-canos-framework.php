<?php
/**
 * Require the Canos Framework plugin with TGM-Plugin-Activation
 *
 *
 * @package Canos
 */

add_action( 'tgmpa_register', 'canos_register_required_plugins' );
/**
 ...
 */
function canos_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Canos Framework', // The plugin name.
            'slug'               => 'canos-framework', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/canos-framework.zip', // The plugin source.
