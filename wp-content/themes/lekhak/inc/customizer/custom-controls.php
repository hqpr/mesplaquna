 ...
 */
class Lekhak_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Lekhak_Dropdown_Category_Control extends WP_Customize_Control {
...
class Lekhak_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Lekhak_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="lekhak-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Lekhak_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class Lekhak_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
...
class Lekhak_Note_Control extends WP_Customize_Control {
