...
if ( ! function_exists( 'lekhak_sanitize_select' ) ) :
	/**
	 ...
	 */
	function lekhak_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'lekhak_sanitize_image' ) ) :
	/**
	 ...
	 */
	function lekhak_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'lekhak_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function lekhak_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'lekhak_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Lekhak 1.0.0
	*/
	function lekhak_sanitize_page( $input ) {
...
if ( ! function_exists( 'lekhak_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Lekhak 1.0.0
	 ...
	 */
	function lekhak_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'lekhak_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Lekhak 1.0.0
	 */
	function lekhak_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'lekhak_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Lekhak 1.0.0
	 */
	function lekhak_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'lekhak_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function lekhak_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function lekhak_sanitize_switch_control( $input ) {
