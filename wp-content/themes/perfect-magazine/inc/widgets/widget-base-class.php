 ...
 * @since 1.0.0
 */
class Perfect_Magazine_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'perfect-magazine' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'perfect-magazine' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'perfect-magazine' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo _x( 'X', 'Remove', 'perfect-magazine' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
